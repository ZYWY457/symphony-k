...
- [ADR-0008: Stage 2 Sandbox Execution Boundary](0008-stage-2-sandbox-execution-boundary.md)
  — Accepted. Its future product role is pending the Issue #87 strategic
  reconciliation; the strategic proposal does not rewrite this accepted
  historical technical decision.
