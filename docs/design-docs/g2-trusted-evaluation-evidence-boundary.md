...
The accepted correction preserves exact target binding, current use-time digest policy, coherent evidence-chain snapshots and caller-safe provider errors. It does not release evaluator assignment, Evaluation integration, M4 effective-use, Outcome disposition/Human acceptance or G3 Effect behavior. **M2-M6 and G3 remain NOT RELEASED.** #113/#114 reconciliation and independent review are COMPLETE / ACCEPTED at `67f91f00ed3d6491f4451b801a19ae20ac409905`; that reconciliation boundary does not replace the M1 implementation boundary. #111 is the current READY / released repository-refresh TaskSpec, with its candidate requiring independent review under #115. These notes update current status only; the historical fact that M1 was unreleased when M0 was accepted and sections 1-16 of the accepted M0 design remain unchanged.
