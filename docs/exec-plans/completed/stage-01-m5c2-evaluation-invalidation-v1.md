...
**Scope:** [Implementation #5C2 / GitHub Issue #11](https://github.com/ZYWY457/symphony-k/issues/11), under the accepted [Stage 1 plan](stage-01-domain-kernel.md), [ADR-0005](../../adr/0005-core-state-machine-semantics.md), and [Evaluation design](../../design-docs/state-machines.md#7-evaluation).
