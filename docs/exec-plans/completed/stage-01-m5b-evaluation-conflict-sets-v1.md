...
**Scope:** [Implementation #5B / GitHub Issue #9](https://github.com/ZYWY457/symphony-k/issues/9), under the accepted [Stage 1 Exec Plan](stage-01-domain-kernel.md), [ADR-0005](../../adr/0005-core-state-machine-semantics.md), and [Evaluation design](../../design-docs/state-machines.md#7-evaluation).
